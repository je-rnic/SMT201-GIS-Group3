...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3414',
            //extent: [103.706246, 1.346003, 360760.000000, 152450.000000],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([11563.193000, 35407.932894, 20704.406800, 41665.110606], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_GeopackageLand_Use_1,
    colName: 'LU_DESC',
    zoom: 10,
    collapsed: true,
    map: map
