...
3. Final MCDA Map Creation:
    ...
    - Set a threshold (for example, 75% score or a value of 3.75 (maximum 5) in our case) to delineate areas considered suitable for solar farm development.
    ...
    - After performing the MCDA analysis, the layers are then reclassified based on the total MCDA score to obtain the suitable areas: 
