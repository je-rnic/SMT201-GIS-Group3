...
3. Final MCDA Map Creation:
    ...
    - Overlay all reclassified layers using weighted overlay analysis to produce a Multi-Criteria Decision Analysis (MCDA) map.

    - After performing the raster calculation, the resulting MCDA map was reclassified based on their total MCDA scores to identify areas of varying suitability. A threshold is then applied—for instance, selecting areas with scores of 3.75 and above (75% of the maximum score of 5)—to delineate zones considered suitable for solar farm development.
