...
During the research phase, we found that an estimated 36.4 km² of land area would be required just to meet Singapore’s projected energy demand in 2030\. This implies that even if the entire mainland were covered with solar panels, it would only be sufficient to meet approximately half of the country's energy needs. 
...
Fig 1\. Solar Irradiance Map captured on 22 March 2025, 12:53pm

![](/images/lessons/image1.jpg)

Fig 2\. Solar Irradiance Map captured on 24 March 2025, 12:16pm

![](/images/lessons/image2.jpg)

Fig 3\. Solar Irradiance Map captured on 25 March 2025, 12:00pm  
![](/images/lessons/image3.jpg)
...
Furthermore, like other groups mentioned during the townhall presentation, with Singapore located along the equator, the solar radiation in Singapore may not differ drastically in the long run (throughout the entire lifespan of solar panels). Hence, our group did not include solar radiation as one of the MCDA criterias.
...
**Iteration 1:**   
![](/images/lessons/image4.png)
![](/images/lessons/image5.png)

*Iteration 1 MCDA Analysis Map (After reclassification)*
...
*Iteration 2 MCDA Analysis Map (After reclassification)*

Legend: 

Blue Color: Suitable areas (\>75% of max score)  
Yellow: Non suitable areas (\<75% of max score)
...
For example, in the Lim Chu Kang site that was selected, while the location is really close to a substation and had a waterbody in close proximity, the satellite image was able to show that the vegetation in the area was well maintained and was likely not a natural vegetation but a managed vegetation.

With this, we were able to cross check with openstreetmap and indeed the site selected is currently occupied by Warren Golf & Country club, which shows that if the site were confirmed to be a solar farm, one of the few downsides would be the golf club would need to relocate to other areas, which may both be logistic issue, and may draw unfavourable feedbacks from the community, especially the members of the golf club.
